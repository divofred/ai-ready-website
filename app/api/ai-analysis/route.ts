          ...
          messages: [
            {
              role: 'system',
              content:
                'You are an AI readiness expert analyzing websites for ANY industry (e-commerce, news, education, healthcare, business, etc). Provide industry-appropriate recommendations. Be specific with examples relevant to the site type.'
            },
            {
              role: 'user',
  ...
  return {
    insights: [
      ...
      },
      {
        ...
        status: 'warning',
        details:
          'Basic structured data present but could be enhanced with more detailed schema markup.',
        recommendation:
          'Add JSON-LD structured data to help AI understand your content better.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'pass',
        details:
          'Site structure is logical and easy to navigate. Good use of internal linking and clear URL structure.',
        recommendation:
          'Excellent crawlability! Your site structure is clear and well-organized.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'warning',
        details:
          'Content provides good informational value but lacks depth in some areas.',
        recommendation:
          'Good informational value. Add more examples to make it even better for AI training.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'warning',
        details:
          'Entities are identifiable but relationships between them are not well-defined.',
        recommendation:
          'Add explicit relationships between your content entities.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'pass',
        details:
          'Clear identification of main entities, brands, and topics throughout the content.',
        recommendation:
          'Good entity identification! Enhance it with proper markup.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'warning',
        details:
          'Main topics are covered but some sections lack comprehensive information.',
        recommendation:
          'Content is fairly complete. Add these sections to fill remaining gaps.',
        actionItems: [
      ...
      },
      {
        ...
        status: 'warning',
        details:
          'Content provides good information but could include more contextual elements.',
        recommendation:
          'Add more context to help AI systems better understand your content.',
        actionItems: [
